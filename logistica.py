...
for id_sucursal_departamento, id_sucursal, id_departamento in sucursal_departamento_data:
    cursor.execute(
        "INSERT INTO Sucursal_Departamento (id_sucursal_departamento, id_sucursal, id_departamento) VALUES (%s, %s)",
...
for id_stock_producto, id_sucursal, id_producto, stock in stock_productos:
    cursor.execute(
        "INSERT INTO Stock_Producto (id_stock_producto, id_sucursal, id_producto, stock) VALUES (%s, %s, %s, %s)",
