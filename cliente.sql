...
-- Descripcion: Tabla que almacena los clientes de la tienda
CREATE TABLE "Cliente" (
  ...
  "telefono" integer  -- Teléfono del cliente
);

-- Crear la tabla Boleta
-- Descripcion: Tabla que almacena las boletas de compra de los clientes
CREATE TABLE "Boleta" (
...
-- Descripcion: Tabla que almacena los detalles de las boletas de compra
...
-- Descripcion: Tabla que almacena los envíos de los productos a los clientes
CREATE TABLE "Envio" (
