...
CREATE TABLE "Producto_Proveedor" (
  "id_producto_proveedor" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Llave primaria, identificador único de la relación producto-proveedor, generado automáticamente
...
CREATE TABLE "Stock_Sucursal" (
  "stock_id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- LLave primaria, identificador único del stock, generado automáticamente
...
CREATE TABLE "Sucursal" (
  "id_sucursal" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Llave primaria, identificador único de la sucursal, generado automáticamente
...
CREATE TABLE "Departamento" (
  "id_departamento" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Llave primaria, identificador único del departamento, generado automáticamente
...
CREATE TABLE "Sucursal_Departamento" (
  "id_sucursal_departamento" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,  -- Llave primaria, identificador único de la relación sucursal-departamento, generado automáticamente
  "id_sucursal" integer,  -- Identificador de la sucursal asociada
